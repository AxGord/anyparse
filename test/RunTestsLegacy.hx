...
import unit.BuiltinFixClassCensusTest;
...
import unit.DefiniteAssignmentGuardTest;
...
class RunTestsLegacy {
	...
	public static function main(): Void {
		...
		addCase(new DefiniteAssignmentGuardTest());
		addCase(new BuiltinFixClassCensusTest());
