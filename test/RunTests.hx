...
class RunTests {
	public static function main() {
		...
		runner.addCase(new JValueTransformSliceTest());
		runner.addCase(new HxTransformSliceTest());
		...
		runner.addCase(new HxStmtBlockEndNoSemiSliceTest());
		runner.addCase(new HxStmtBeforeCaseNoSemiSliceTest());
		runner.addCase(new HxAbstractClassSliceTest());
		runner.addCase(new HxModifierFlattenSliceTest());
		...
		runner.addCase(new HxCaseCaptureSliceTest());
...
runner.addCase(new HxEnumAbstractSliceTest());
		...
		runner.addCase(new HxAfterLeftCurlySliceTest());
		runner.addCase(new HxCaseBodySameLineSliceTest());
		...
		runner.addCase(new HxNumericSeparatorSliceTest());
		...
		runner.addCase(new HxStructFieldTrailPresentSliceTest());
		...
		runner.addCase(new HxLambdaParamOptionalSliceTest());
		...
		runner.addCase(new HxConditionalSourceBlankSliceTest());
		...
		runner.addCase(new RenameSliceTest());
		runner.addCase(new InlineSliceTest());
		runner.addCase(new ExtractVarSliceTest());
		runner.addCase(new AddParamSliceTest());
		runner.addCase(new ChangeSigSliceTest());
		runner.addCase(new RemoveParamSliceTest());
		runner.addCase(new CrossRenameSliceTest());
		runner.addCase(new SymbolIndexSliceTest());
		runner.addCase(new MoveSymbolSliceTest());
		...
		runner.addCase(new ApqPrefilterCliTest());
		runner.addCase(new ApqSourceMetaArgCliTest());
