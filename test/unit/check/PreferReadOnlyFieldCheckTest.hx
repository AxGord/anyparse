...
class PreferReadOnlyFieldCheckTest extends Test {
	...
	/**
	 * DELIBERATE NON-GATE, the twin of `PreferFinalPublicFieldCheckTest`'s pin. On the `-cs`
	 * target, `public var x:String` and `public var x(default, null):String` on a
	 ...
	 * warranted. Re-check the emitted output before changing this.
	 */
