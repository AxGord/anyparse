...
final class HxTernaryBranchChainIndentTest extends Test {
	...
	public function testCallArgTernaryThenBranchChainIndentsBelowBranchLine(): Void {
		Assert.equals(
			...
			triviaWrite(
				"class Sample {\n\tfunction run() {\n\t\temitTrace(actionName, spanPath, succeeded, markerNode != null ? ', local span path -> resolved span path of the marker node, kept verbatim' + ', node id and node stamp plus the resolved parent chain of that marker' : '', posInfo);\n\t}\n}",
				CFG
			)
		);
	}
	...
	public function testCallArgTernaryConditionChainIndentsBelowConditionLine(): Void {
		Assert.equals(
			...
			triviaWrite(
				"class Sample {\n\tfunction run() {\n\t\temitTrace(actionName, spanPath, succeeded, markerNode != null && parentNode != null && resolvedSpan != null && pendingStamp != null && trailingAnchor != null && closingAnchor != null ? 'yes' : '', posInfo);\n\t}\n}",
				CFG
			)
		);
	}
	...
	public function testParenHostTernaryThenBranchChainKeepsItsIndent(): Void {
		Assert.equals(
			...
			triviaWrite(
				"class Sample {\n\tfunction run() {\n\t\treturn emitTrace('prefix span: ' + (markerNode != null ? ', local span path -> resolved span path of the marker node, kept verbatim' + ', node id and node stamp plus the resolved parent chain of that marker' : ''));\n\t}\n}",
				CFG
			)
		);
	}
	...
	public function testBranchChainStaysFlatAtExactLimit(): Void {
		Assert.equals(
			"class Sample {\n\n\tfunction run() {\n\t\temitTrace(\n\t\t\talpha, beta,\n\t\t\tmarkerNode != null\n\t\t\t\t? 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa' + 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'\n\t\t\t\t: '',\n\t\t\tgamma\n\t\t);\n\t}\n\n}",
			triviaWrite(
				"class Sample {\n\tfunction run() {\n\t\temitTrace(alpha, beta, markerNode != null ? 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa' + 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb' : '', gamma);\n\t}\n}",
				CFG
			)
		);
	}
	...
	public function testBranchChainBreaksOneOverLimit(): Void {
		Assert.equals(
			...
			triviaWrite(
				"class Sample {\n\tfunction run() {\n\t\temitTrace(alpha, beta, markerNode != null ? 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa' + 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb' : '', gamma);\n\t}\n}",
				CFG
			)
		);
	}
	...
	public function testBranchChainFillPackingCountsTheDeeperIndent(): Void {
		Assert.equals(
			...
			triviaWrite(
				"class Sample {\n\tfunction run() {\n\t\temitTrace(alpha, beta, markerNode != null ? 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa' + 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb' + 'ccccccccccccccccccccccccccccccccccccccccccccccccccccccccc' : '', gamma);\n\t}\n}",
				CFG
			)
		);
	}
