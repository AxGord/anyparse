...
final class ProseClaimCensusTest extends Test {
	...
	private static final BASELINE: Array<String> = [
		...
		'unit.check.OrphanAccessorCheckTest#testAnUnreadableCallerOutsideTheReportScopeStillDeclinesTheDeletion :: base',
		'unit.check.OrphanAccessorCheckTest#testAnUnreadableSubtypeOutsideTheReportScopeStillDowngradesTheReport :: base',
		'unit.check.OrphanAccessorCheckTest#testAnUnreadableThirdPartyFileSpellingTheAccessorStillDeclines :: base',
		'unit.check.OrphanAccessorCheckTest#testAnUnreadableThirdPartySubtypeDoesNotDeclineAProjectDeletion :: base',
		...
		'unit.check.PossibleNullDereferenceTest#testFieldPathMapExistsGuardedNotFlagged :: vacuity',
		...
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testADocCommentsGenuinelyEmptyInteriorLinesAreContentToo :: base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testAGutterlessBlockCommentBlankRunIsNotACapCandidate :: control,base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testAMarkedBreakRecordsTheOffsetItsLineEndLandsOn :: base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testAStringLiteralBlankRunIsNotACapCandidate :: base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testTheCapKeepsTheIndentOnTheBlankRowItKeeps :: base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testTheCapSeesBlankRowsCarryingTrailingWhitespaceIndent :: base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testTheCapTrimsCodeBlanksBesideALiteralThatKeepsItsOwn :: base',
		'unit.grammar.haxe.HxMaxAnywhereInFileSliceTest#testTheMacroJoinedCommentPathKeepsItsBlankRun :: base',
		...
		'unit.grammar.haxe.HxValueIfCurlyElseJoinSliceTest#testTheJoinedLayoutIsIdempotent :: base',
		'unit.grammar.haxe.HxValueIfCurlyElseJoinSliceTest#testTheReportedValueIfJoinsItsElseToTheCurlyClose :: base',
		'unit.grammar.haxe.HxValueIfCurlyElseJoinSliceTest#testTheSemicolonBeforeElseGoesWithTheJoin :: base',
		...
		'unit.query.CondQueryTest#testTheLongerSigilWinsWhateverOrderTheGrammarDeclares :: control',
		'unit.query.DocOwnerGuardSliceTest#testInsertAboveTheDocIsAccepted :: control',
		'unit.query.ExtractInterfaceSliceTest#testANonCanonicalSourceIsNotReformatted :: control,base',
		...
		'unit.query.ExtractInterfaceSliceTest#testTheEditedSourceComesBackCanonical :: base',
		'unit.query.ExtractSuperclassSliceTest#testABlankRunInsideAStringLiteralSurvivesACutElsewhere :: base',
		'unit.query.ExtractSuperclassSliceTest#testTheEditedSourceComesBackCanonical :: base',
		'unit.query.ImplicitStdScopeTest#testConfigLessUnresolvableImportStaysInfoAndSurvivesFix :: control',
		'unit.query.IntroduceParameterObjectSliceTest#testAnUntouchedMultilineLiteralKeepsItsBlankRun :: base',
		'unit.query.IntroduceParameterObjectSliceTest#testTheCliHandsTheOpTheFilesOwnFormatConfig :: base',
		'unit.query.IntroduceParameterObjectSliceTest#testTheRewrittenSourceComesBackCanonical :: base',
		'unit.query.LexicalRegionsSeamTest#testTheEngineNamesNoHaxeGrammarRuleType :: base',
		'unit.query.LiteralVocabularyTest#testAnUndeclaredDelimiterLeavesTheNameSlotVerbatim :: control',
