...
final class ProseClaimCensusTest extends Test {
	...
	private static final BASELINE: Array<String> = [
		...
		'unit.check.JoinSingleUseLocalCheckTest#testAnnotationRestatesSourceFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testCommentBetweenStatementsStillFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testConditionalBareIdentStillFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testConditionalRegionWithoutStrayReadStillFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testImmutableLocalCaptureStillFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testInitIdentNotReboundStillFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testTrailingStatementWithoutInterpolationStillFlagged :: control',
		'unit.check.JoinSingleUseLocalCheckTest#testUnconditionalFieldChainStillFlagged :: control',
		...
		'unit.check.PreferFinalAbstractMethodCheckTest#testClassTypedFieldMethodCallStillFlagged :: control',
		'unit.check.PreferFinalAbstractMethodCheckTest#testPlainFieldStillFlagged :: control',
		'unit.check.PreferFinalAbstractMethodCheckTest#testPlainLocalStillFlagged :: control',
		'unit.check.PreferFinalAbstractMethodCheckTest#testPrivateCtorOnlyNoMetaStillFlagged :: control',
		'unit.check.PreferFinalAbstractMethodCheckTest#testResolutionScopeResolvesLibraryType :: control',
		'unit.check.PreferFinalAbstractMethodCheckTest#testStdlibArrayFieldMethodCallStillFlagged :: control',
		...
		'unit.grammar.haxe.HxCallGroupRestProbeCasePatternTest#testCasePatternCtorInsideACollectionStaysGlued :: arm,control',
		...
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testDocOnSecondDeclIsNotAFileHeader :: arm,control,base',
		...
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testFileHeaderBlankBeforeConditionalImportBlock :: arm,control,base',
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testFileHeaderBlankBeforeLeadingImport :: arm,control,base',
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testFileHeaderBlankBeforePackage :: arm,control,base',
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testHeaderSeparatedFromDocButDocKeepsItsType :: arm,control,base',
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testLineCommentHeaderLeavesDocAttached :: arm,control,base',
		'unit.grammar.haxe.HxFileHeaderCommentSliceTest#testNoFileHeaderBlankWithoutImports :: arm,control,base',
		'unit.grammar.haxe.HxGroupRestProbeStructStarTest#testCasePatternTypeParamsDeclineTheRestProbe :: arm',
		...
		'unit.query.MoveSymbolSliceTest#testACommentOnlyMentionIsNotAReference :: control',
		'unit.query.MoveSymbolSliceTest#testACommentsTrailingPeriodDoesNotHideTheReferenceOwedARepairImport :: control',
		'unit.query.MoveSymbolSliceTest#testACutBeforeATrailingCommentKeepsOneSeparator :: control',
		'unit.query.MoveSymbolSliceTest#testAMiddleDeclarationWithOneBlankSideKeepsIt :: control',
		'unit.query.MoveSymbolSliceTest#testASiblingPackageIsNotAnAncestorSoItIsLeftAlone :: control',
		'unit.query.MoveSymbolSliceTest#testAValuePositionIsStillNotPriced :: control',
		'unit.query.MoveSymbolSliceTest#testAliasDependencyIsCarriedIntoTheDestination :: control',
		'unit.query.MoveSymbolSliceTest#testAliasImporterRepointedKeepingItsBinding :: control',
		'unit.query.MoveSymbolSliceTest#testAnAmbientTopLevelDependencyIsNotACollision :: base',
		'unit.query.MoveSymbolSliceTest#testBareSamePackageDependencyIsPricedToo :: control',
		'unit.query.MoveSymbolSliceTest#testCrossPackageAliasImporterNotMistakenForAnFqnReference :: control',
		'unit.query.MoveSymbolSliceTest#testCuttingAMiddleDeclarationLeavesExactlyOneSeparator :: control,base',
		'unit.query.MoveSymbolSliceTest#testCuttingTheLastDeclarationOfAModuleTakesItsSeparator :: control,base',
