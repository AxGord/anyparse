...
final class HxVarInitBreakAfterEqOverflowTest extends Test {
	...
	public function testStringAtomPastLimitBreaksAfterEq(): Void {
		...
		final glued: String =
			"class C {\n\tfunction f() {\n\t\tfinal newSharePath:String = '${Prefix.SHARED_ROOT_WITH_SLASH + ownerAccountName}/$oldSharedFirstPart$newSharedLastPart$pathLastPart';\n\t}\n}";
		final broken: String =
	...
	public function testStringAtomExactlyOnLimitStaysGlued(): Void {
		...
		final src: String =
			"class C {\n\tfunction f() {\n\t\tfinal newShareTag:String = '${Prefix.SHARED_ROOT_WITH_SLASH + ownerAccountName}/$oldSharedFirstPart$newSharedLastPart$pathLastPart';\n\t}\n}";
	...
	public function testUntypedDeclPastLimitBreaksAfterEq(): Void {
		...
		final glued: String =
			"class C {\n\tfunction f() {\n\t\tfinal newSharedItemPath = '${Prefix.SHARED_ROOT_WITH_SLASH + ownerAccountNameXy}/$oldSharedFirstPart$newSharedLastPart$pathLastPart';\n\t}\n}";
		final broken: String =
	...
	public function testWrappableCallRhsKeepsEqGlued(): Void {
		...
		final src: String =
			"class C {\n\tfunction f() {\n\t\tfinal sharedPathCacheKey:String = buildSharedPathCacheKeyFromParts(ownerAccountName, oldSharedFirstPart, newSharedLastPart, pathLastPart);\n\t}\n}";
