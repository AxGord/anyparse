...
final class HxParenTernaryOpenWrapSliceTest extends Test {
	...
	private static final SRC: String = 'class Sample {\n\tfunction run() {\n'
		+ '\t\tspriteMarkItem.x = offsetX + (node.bucket ? MeasureMap.PANEL_ROW_GRID_INDENT_MARK_ICON : !_fixedMarkSearch ? '
		+ 'MeasureMap.PANEL_ROW_GRID_INDENT_MARK_ICON : MeasureMap.PANEL_ROW_GRID_INDENT_MARK_ICON_FIXED_MARK_SEARCH);\n\t}\n}';
	private static final SRC_OPADDSUB: String = 'class Sample {\n\tfunction run() {\n\t\tsummaryLine = headMarkNode != null ? ('
		+ "(headMarkNode.parentRef != null ? ', parent mark id: ' + headMarkNode.parentRef.markIdValue : '') "
		+ '+ \', mark id: \' + headMarkNode.markIdValue + \', stamp: \' + headMarkNode.stampValue) : \'\';\n\t}\n}';
	...
	public function testExactMaxLineLengthKeepsParenTernaryFlat(): Void {
		final src: String = 'class Sample {\n\tfunction run() {\n\t\treturn baseSpan != null ? baseSpan - ('
			+ 'headNode != null ? headNode.width - gapMetr + headNode.padStart * 2 : 0) - tailPad * 2 : null;\n\t}\n}';
		Assert.equals(
			'class Sample {\n\n\tfunction run() {\n\t\treturn baseSpan != null ? baseSpan - ('
			+ 'headNode != null ? headNode.width - gapMetr + headNode.padStart * 2 : 0) - tailPad * 2 : null;\n\t}\n\n}',
			triviaWrite(src, CFG)
	...
	public function testExactMaxLineLengthKeepsParenOpAddSubFlat(): Void {
		final src: String = 'class Sample {\n\tfunction run() {\n\t\treturn baseSpan != null ? baseSpanValue - ('
			+ 'headWidthValueX + gapMetricValueXY + padStartValFinalXX) - tailPaddingValueHereXX : null;\n\t}\n}';
		Assert.equals(
			'class Sample {\n\n\tfunction run() {\n\t\treturn baseSpan != null ? baseSpanValue - ('
			+ 'headWidthValueX + gapMetricValueXY + padStartValFinalXX) - tailPaddingValueHereXX : null;\n\t}\n\n}',
			triviaWrite(src, CFG)
	...
	public function testExactMaxLineLengthKeepsParenOpBoolFlat(): Void {
		final src: String = 'class Sample {\n\tfunction run() {\n\t\tif (isArrowBodyMarkerLongName || isMethodChainItemLong || '
			+ '!(startsCollectionDelimHere || firstBreakIsArrayDelimValXXXXX)) return -1;\n\t}\n}';
		Assert.equals(
			'class Sample {\n\n\tfunction run() {\n\t\tif (isArrowBodyMarkerLongName || isMethodChainItemLong || '
			+ '!(startsCollectionDelimHere || firstBreakIsArrayDelimValXXXXX)) return -1;\n\t}\n\n}',
			triviaWrite(src, CFG)
