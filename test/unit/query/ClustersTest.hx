...
class ClustersTest extends Test {
	 ...
	 */
	private static final HUB_GLUED: String = 'class A { function a():Void { b(); log(); } function b():Void log(); function c():Void {'
		+ ' d(); log(); } function d():Void log(); function log():Void {} }';

	/**
	 * HUB_GLUED with the hub calling back into the second island.
	 */
	private static final HUB_CALLBACK: String = 'class A { function a():Void { b(); log(); } function b():Void log(); function c():Void {'
		+ ' d(); log(); } function d():Void log(); function log():Void d(); }';
