...
class HxObjectLitSliceTest extends HxTestHelpers {
	...
	public function testMultipleFields(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit(3 fields)');
		}
	}
	...
	public function testNestedObjectLit(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit');
		}
	}
	...
	public function testObjectLitMixedValueTypes(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit(4 fields)');
		}
	}
	...
	public function testObjectLitInBinop(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected GtEq(v, ObjectLit)');
		}
	}
	...
	public function testQuotedKey(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit({"name":1})');
		}
	}
	...
	public function testMixedBareAndQuotedKeys(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit(2 mixed-key fields)');
		}
	}
	...
	public function testQuotedKeyIssue60RoundTrip(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit({"i":0})');
		}
	...
	public function testStringValueKeyUnaffected(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected ObjectLit({x:"v"})');
		}
	}
