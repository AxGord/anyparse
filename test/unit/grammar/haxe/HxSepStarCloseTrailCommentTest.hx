...
class HxSepStarCloseTrailCommentTest extends Test {
	 ...
	 *
	 * LEFT ALONE ON PURPOSE: the shape has a population of ZERO outside this
	 * fixture — a lone-closer line that is not dedented relative to the content
	 * line above it occurs nowhere across the anyparse and Pony trees under
	 * EACH of its two configs, with or without the `//` precondition. And the
	 * closer is not the list
