...
final class HxAssignChainWrapSliceTest extends Test {
	...
	public inline function testSingleAssignWithWrappingCallStaysUnchanged(): Void {
		...
		assertCallAbsorbsTheOverflow(
			'class Sample {\n\n\tfunction run() {\n\t\t_target.handlerSlot = buildTheHandlerForSequence(firstArgumentValue, '
			+ 'secondArgumentValue, thirdArgumentValue, fourthArgumentValueXy);\n\t}\n\n}',
	...
	public inline function testAssignChainWithWrappingCallStaysUnchanged(): Void {
		...
		assertCallAbsorbsTheOverflow(
			'class Sample {\n\n\tfunction run() {\n\t\t_target.slotA = _target.slotB = buildTheHandlerForSequence(firstArgumentValue, '
			+ 'secondArgumentValue, thirdArgumentValue, fourthArgValue);\n\t}\n\n}',
	...
	public function testOverflowingAssignChainBreaksAfterEquals(): Void {
		...
		final flat: String = 'class Sample {\n\n\tfunction run() {\n\t\t_seg1.onFinished = _seg2.onFinished = _seg3.onFinished = '
			+ '_seg4.onFinished = _seg5.onFinished = _seg6.onFinished = _seg7.onFinished = stopTheSequence;\n\t}\n\n}';
		final wrapped: String = 'class Sample {\n\n\tfunction run() {\n\t\t_seg1.onFinished = _seg2.onFinished = _seg3.onFinished = '
			+ '_seg4.onFinished = _seg5.onFinished = _seg6.onFinished =\n\t\t\t_seg7.onFinished = stopTheSequence;\n\t}\n\n}';
	...
	public function testAssignChainAtExactlyMaxLineLengthStaysFlat(): Void {
		...
		final src: String = 'class Sample {\n\n\tfunction run() {\n\t\t_seg1.onFinished = _seg2.onFinished = _seg3.onFinished = '
			+ '_seg4.onFinished = _seg5.onFinished = _seg6.onFinished = terminateSequence;\n\t}\n\n}';
		Assert.equals(src, triviaWrite(src));
	}
