...
class HxInterfaceInterMemberBlankLinesOptionsTest extends Test {
	...
	public function testInterfaceBetweenFunctionsZeroKeepsTight(): Void {
		final out: String = writeWith('interface I { public function a():Void; public function b():Void; }', 0, 0, 0);
		Assert.isTrue(
			out.indexOf('a():Void;\n\tpublic function b') != -1,
	...
	public function testInterfaceBetweenFunctionsOneInsertsBlank(): Void {
		final out: String = writeWith('interface I { public function a():Void; public function b():Void; }', 0, 1, 0);
		Assert.isTrue(
			out.indexOf('a():Void;\n\n\tpublic function b') != -1,
	...
	public function testInterfaceBetweenVarsOneInsertsBlank(): Void {
		final out: String = writeWith('interface I { public var a:Int; public var b:Int; }', 1, 0, 0);
		Assert.isTrue(
	...
	public function testInterfaceAfterVarsOneInsertsBlankOnVarToFunction(): Void {
		final out: String = writeWith('interface I { public var a:Int; public function b():Void; }', 0, 0, 1);
		Assert.isTrue(
			out.indexOf('var a:Int;\n\n\tpublic function b') != -1,
	...
	public function testInterfaceAfterVarsOneInsertsBlankOnFunctionToVar(): Void {
		final out: String = writeWith('interface I { public function a():Void; public var b:Int; }', 0, 0, 1);
		Assert.isTrue(
			out.indexOf('a():Void;\n\n\tpublic var b') != -1,
	...
	public function testClassKnobsDoNotAffectInterface(): Void {
		...
		final out: String = HaxeModuleTriviaWriter.write(
			HaxeModuleTriviaParser.parse('interface I { public function a():Void; public function b():Void; }'), opts
		);
		Assert.isTrue(
			out.indexOf('a():Void;\n\tpublic function b') != -1,
	...
	public function testInterfaceKnobsDoNotAffectClass(): Void {
		...
		final out: String = HaxeModuleTriviaWriter.write(
			HaxeModuleTriviaParser.parse('class M { public var a:Int; public var b:Int; }'), opts
		);
		Assert.isTrue(
			out.indexOf('var a:Int;\n\tpublic var b') != -1,
