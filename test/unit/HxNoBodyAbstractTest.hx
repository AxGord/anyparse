...
class HxNoBodyAbstractTest extends HxTestHelpers {
	...
	public function testInterfaceMultipleMethodsNoBody(): Void {
		final fns: Array<HxFnDecl> = parseInterfaceMembers('interface IFoo { function a():Int; function b(x:String):Void; }');
	...
	public function testBlockBodyStillWorksAlongsideNoBody(): Void {
		final fns: Array<HxFnDecl> =
			parseInterfaceMembers('interface IFoo { function a():Void; function b():Int { return 1; } function c():Bool; }');
		...
		switch fns[1].body {
			...
			case _:
				Assert.fail('expected BlockBody for fns[1]');
		}
