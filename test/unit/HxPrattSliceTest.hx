...
class HxPrattSliceTest extends HxTestHelpers {
	...
	public function testFloatLit(): Void {
		...
		switch decl.init {
			case FloatLit(v):
				Assert.floatEquals(3.14, (v: Float));
			case null, _:
				Assert.fail('expected FloatLit(3.14), got ${decl.init}');
		}
	}
	...
	public function testFloatLitWithExponent(): Void {
		...
		switch decl.init {
			case FloatLit(v):
				Assert.floatEquals(1.0e3, (v: Float));
			case null, _:
				Assert.fail('expected FloatLit(1000), got ${decl.init}');
		}
	}
	...
	public function testFloatLitTrailingDot(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected FloatLit("1."), got ${decl.init}');
		}
	}
	...
	public function testTrueishIsIdentifier(): Void {
		...
		switch decl.init {
			case IdentExpr(v):
				Assert.equals('trueish', (v: String));
			case null, _:
				Assert.fail('expected IdentExpr("trueish"), got ${decl.init}');
		}
	}
	...
	public function testNullableIsIdentifier(): Void {
		...
		switch decl.init {
			case IdentExpr(v):
				Assert.equals('nullable', (v: String));
			case null, _:
				Assert.fail('expected IdentExpr("nullable"), got ${decl.init}');
		}
	}
	...
	public function testFalseyIsIdentifier(): Void {
		...
		switch decl.init {
			case IdentExpr(v):
				Assert.equals('falsey', (v: String));
			case null, _:
				Assert.fail('expected IdentExpr("falsey"), got ${decl.init}');
		}
	}
	...
	public function testExprThroughModuleRoot(): Void {
		...
		switch aVar.init {
			case Add(IntLit(_), Mul(IntLit(_), IntLit(_))):
				Assert.pass();
			case null, _:
				Assert.fail('expected Add(_, Mul(_, _)), got ${aVar.init}');
		}
		...
		switch bVar.init {
			case FloatLit(v):
				Assert.floatEquals(0.5, (v: Float));
			case null, _:
				Assert.fail('expected FloatLit(0.5), got ${bVar.init}');
		}
	}
