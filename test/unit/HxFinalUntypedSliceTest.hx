...
class HxFinalUntypedSliceTest extends HxTestHelpers {
	...
	public function testFinalStmtTyped(): Void {
		...
		switch stmts[0] {
			...
			case null, _:
				Assert.fail('expected FinalStmt(typed)');
		}
	}
	...
	public function testFinalStmtNoInit(): Void {
		...
		switch stmts[0] {
			...
			case null, _:
				Assert.fail('expected FinalStmt(no init)');
		}
	}
	...
	public function testFinalStmtMultipleInBody(): Void {
		...
		switch stmts[0] {
			...
			case null, _:
				Assert.fail('expected FinalStmt');
		}
		switch stmts[1] {
			case VarStmt(d):
	...
	public function testFinalStmtIdentifierPrefixNotConsumed(): Void {
		...
		switch stmts[0] {
			case VarStmt(d):
				Assert.equals('finalists', (d.name: String));
			case null, _:
				Assert.fail('expected VarStmt(finalists)');
		}
	}
	...
	public function testUntypedAtom(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected UntypedExpr(IntLit), got ${decl.init}');
		}
	}
	...
	public function testUntypedWrapsIdent(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected UntypedExpr(IdentExpr)');
		}
	}
	...
	public function testUntypedWrapsCall(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected UntypedExpr(Call)');
		}
	}
	...
	public function testUntypedAsStatement(): Void {
		...
		switch stmts[0] {
			case ExprStmt(UntypedExpr(Call(IdentExpr(name), _))):
				Assert.equals('foo', (name: String));
			case null, _:
				Assert.fail('expected ExprStmt(UntypedExpr(Call))');
		}
	}
	...
	public function testUntypedScopesFullExpression(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected UntypedExpr(Add(a, b)), got ${decl.init}');
		}
	}
	...
	public function testUntypedNested(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected UntypedExpr(UntypedExpr(x))');
		}
	}
	...
	public function testUntypedIdentifierPrefixNotConsumed(): Void {
		...
		switch decl.init {
			...
			case null, _:
				Assert.fail('expected IdentExpr(untypedFoo)');
		}
	}
	...
	public function testUntypedAtomBareInReturn(): Void {
		...
		final stmts: Array<HxStatement> = fnBodyStmts(fn);
		switch stmts[0] {
			case ReturnStmt(UntypedAtom):
				Assert.pass();
			case null, _:
				Assert.fail('expected ReturnStmt(UntypedAtom), got ${stmts[0]}');
		}
	}
	...
	public function testUntypedBlockStmtAsStatement(): Void {
		...
		switch stmts[0] {
			...
			case null, _:
				Assert.fail('expected UntypedBlockStmt, got ${stmts[0]}');
		}
	}
