...
class HaxeFormatConfigLoaderTest extends Test {
	...
	public function testTrailingCommasYesFlipsFlag(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson('{"trailingCommas": {"arrayLiteralDefault": "yes"}}');
	...
	public function testIndentationTwoSpaces(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson('{"indentation": {"character": "  ", "tabWidth": 2}}');
	...
	public function testIndentationTabKeepsTabWidth(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson('{"indentation": {"character": "tab", "tabWidth": 8}}');
	...
	public function testWrappingMaxLineLength(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson('{"wrapping": {"maxLineLength": 200}}');
	...
	public function testWhitespaceObjectFieldColonNoneBeforeMapsToNone(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson(
			'{"whitespace": {"objectFieldColonPolicy": "noneBefore"}}'
		);
		Assert.equals(WhitespacePolicy.None, opts.objectFieldColon);
	}
	...
	public function testWhitespaceObjectFieldColonOnlyAfterMapsToAfter(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson(
			'{"whitespace": {"objectFieldColonPolicy": "onlyAfter"}}'
		);
		Assert.equals(WhitespacePolicy.After, opts.objectFieldColon);
	}
	...
	public function testWhitespaceParenConfigClosingPolicyIsIgnored(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson(
			'{"whitespace": {"parenConfig": {"funcParamParens": {"closingPolicy": "before"}}}}'
		);
		Assert.equals(WhitespacePolicy.None, opts.funcParamParens);
	}
	...
	public function testWhitespaceCallParensClosingPolicyIsIgnored(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson(
			'{"whitespace": {"parenConfig": {"callParens": {"closingPolicy": "before"}}}}'
		);
		Assert.equals(WhitespacePolicy.None, opts.callParens);
	}
	...
	public function testEmptyLinesAfterVarsMapsToInt(): Void {
		final opts: HxModuleWriteOptions = HaxeFormatConfigLoader.loadHxFormatJson('{"emptyLines": {"classEmptyLines": {"afterVars": 3}}}');
	...
	public function testEmptyLinesBeforeDocCommentComposesWithRemove(): Void {
		...
		final out: String = HaxeModuleTriviaWriter.write(HaxeModuleTriviaParser.parse(src), opts);
		Assert.isTrue(
			out.indexOf('a():Void {}\n\tpublic function c') != -1, 'expected blank between a() and c() stripped by `remove` in: <$out>'
		);
		Assert.isTrue(
			out.indexOf('c():Void {}\n\n\t/** */\n\tpublic function b') != -1,
