 ...
 * diff on failure (`diffedMsg`) instead of naming only the failing test method.
 */
@:nullSafety(Strict)
class TestDiscoveryParityTest extends Test {
	...
	private static final REGISTERED_CLASSES: Array<String> = [
		...
		'unit.check.AvoidDynamicParamAscriptionFixTest',
		...
		'unit.check.CommentWidthCheckTest',
		...
		'unit.check.UnusedLoopBinderCheckTest',
		...
		'unit.cli.ApqResolveDefineCliTest',
		...
		'unit.cli.CliUnknownSubcommandTest',
		...
		'unit.cli.ScratchIsolationGateTest',
		...
		'unit.grammar.haxe.HxExprForGuardGlueSliceTest',
		...
		'unit.grammar.haxe.HxFormatConfigNoDeadKeysTest',
		...
		'unit.query.SymbolIndexConversionFreeSliceTest',
	...
	public function testThePilotPinsReachTheGeneratedRegistry(): Void {
		final expectedPins: Array<String> = [
			...
			'unit.MutationArmsTest#testAForcedRowWithFragmentListsIsRefused :: control :: M-ARM-ROW-OK',
			'unit.MutationArmsTest#testAKindedArmSpellsItsKindInTheAddress :: control :: M-ARM-KIND-UNSPELLED',
			'unit.MutationArmsTest#testAMalformedFragmentListIsNamedByItsKeyAlone :: control :: M-ARM-ROW-OK',
			'unit.MutationArmsTest#testAMismatchedPairCountIsRefused :: control :: M-ARM-ROW-OK',
			'unit.MutationArmsTest#testAModulePathBecomesTheTwoCandidateFiles :: control :: M-ARM-PATH-FLAT',
			'unit.MutationArmsTest#testAMultiPairCutCarriesEveryFragment :: guard :: ',
			'unit.MutationArmsTest#testANonJsonTableIsOneComplaint :: guard :: ',
			'unit.MutationArmsTest#testAPairThatChangesNothingIsRefused :: control :: M-ARM-ROW-OK',
			...
			'unit.MutationArmsTest#testAnEmptyFragmentArrayIsRefused :: control :: M-ARM-ROW-OK',
			...
			'unit.check.CommentWidthCheckTest#testATrailingCommentBehindOverWideCodeIsNotThisRulesFinding :: control :: '
				+ 'M-COMMENT-WIDTH-CODE-BLIND',
			'unit.check.CommentWidthCheckTest#testATrailingCommentIsReportOnly :: control :: M-COMMENT-WIDTH-TRAILING-WRAPPED',
			'unit.check.CommentWidthCheckTest#testCodeOnBothSidesOfAShortCommentIsNotThisRulesFinding :: control :: '
				+ 'M-COMMENT-WIDTH-CODE-BLIND',
			'unit.check.CommentWidthCheckTest#testOnlyTheLinesTheViolationsNameAreReflowed :: control :: M-COMMENT-WIDTH-PROTECTION-OFF',
			'unit.check.CommentWidthCheckTest#testTheConfiguredWidthIsRead :: control :: M-COMMENT-WIDTH-CONFIG-BLIND',
			...
			'unit.check.PreferKeyValueLoopCheckTest#testNestedLoopsDerivingOneBinderAreReportOnly :: control :: '
				+ 'M-ELEMENT-LOOP-NESTED-BINDER',
			'unit.check.PreferKeyValueLoopCheckTest#testNoOpenerBinderTakenByFieldIsReportOnly :: control :: M-KV-NOOPENER-TAKEN-MEMBER',
			'unit.check.PreferKeyValueLoopCheckTest#testNoOpenerBinderTakenInFunctionIsReportOnly :: control :: M-KV-NOOPENER-TAKEN-SCOPE',
			...
			'unit.check.PreferKeyValueLoopCheckTest#testNoOpenerSelfCallIsReportOnly :: control :: M-KV-NOOPENER-SELF-CALL',
			'unit.check.PreferKeyValueLoopCheckTest#testNoOpenerShadowedIndexNotFlagged :: control :: M-ELEMENT-LOOP-REBIND',
			'unit.check.PreferKeyValueLoopCheckTest#testNoOpenerSlotWriteNotFlagged :: control :: M-ELEMENT-LOOP-UNSTABLE',
			'unit.check.PreferKeyValueLoopCheckTest#testOpenerSelfCallIsReportOnly :: control :: M-KV-OPENER-SELF-CALL',
			'unit.check.PreferKeyValueLoopCheckTest#testOpenerWithSecondReadStaysUnclaimed :: control :: M-KV-NOOPENER-OPENER-CLAIM',
			...
			'unit.check.PreferValueLoopCheckTest#testSelfCallIsReportOnly :: control :: M-VALUE-LOOP-SELF-CALL',
			'unit.check.PreferValueLoopCheckTest#testStaticAndConstructorCallsAreReportOnly :: control :: '
			...
			'unit.check.UnusedLoopBinderCheckTest#testCounterLoopLeftToItsRule :: control :: M-ULB-COUNTER-CLAIM-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testImportAliasedListNotDropped :: control :: M-ULB-IMPORT-ALIAS-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testImportOfAnotherListNotDropped :: control :: M-ULB-IMPORT-REBIND-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testMacroReificationRefuses :: control :: M-ULB-COVERAGE-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testNativeCodeRefuses :: control :: M-ULB-NATIVE-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testObjectLiteralFieldNameIsNoRead :: control :: M-ULB-FIELD-NAME-AS-READ',
			'unit.check.UnusedLoopBinderCheckTest#testOpaqueCondRegionRefuses :: control :: M-ULB-OPAQUE-COND-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testOuterWildcardReadRefuses :: control :: M-ULB-OUTER-WILDCARD-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testProjectListShadowNotDropped :: control :: M-ULB-VALUE-ITERATION-SHADOW-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testReassignedLocalKeyRenamedNotDropped :: control :: M-ULB-REASSIGNED-LOCAL-BLIND',
			'unit.check.UnusedLoopBinderCheckTest#testShadowAfterRealReadNotFlagged :: control :: M-ULB-OUTER-BINDING-AS-SHADOW',
			...
			'unit.check.UnusedLoopBinderCheckTest#testWildcardBinderNotFlagged :: control :: M-ULB-WILDCARD-KEY-ADMITTED',
			...
			'unit.grammar.haxe.HxLoopBodyIfElseSliceTest#testGuardStaysGluedUnderEveryPlacement :: control :: M-LOOPIF-ALWAYS',
			'unit.grammar.haxe.HxLoopBodyIfElseSliceTest#testKeepPlacementObeysTheKeyAndStillReadsTheSource :: control :: '
				+ 'M-LOOPIF-KEEP-BLIND',
			...
			'unit.query.CommentRewriteSliceTest#testJoinedRunLineIsReflowed :: control :: M-COMMENT-REFLOW-ABSENT',
			...
			'unit.query.CommentRewriteSliceTest#testLineCommentRunMatchesAcrossItsLines :: control :: M-COMMENT-RUN-PER-TOKEN',
		...
		Assert.same(
			expectedPins, actualPins, diffedMsg(expectedPins, actualPins, 'the pin annotations, with their roles and killing arms')
		);
	}
	...
	public function testTheArmRegistryReachesTheGeneratedRegistry(): Void {
		final expectedArms: Array<String> = [
			...
			'M-COMMENT-RUN-PER-TOKEN',
			'M-COMMENT-RUN-OPENER-UNGUARDED',
			'M-COMMENT-MARKER-FORCED',
			'M-COMMENT-REFLOW-ABSENT',
			'M-COMMENT-REFLOW-GREEDY',
			'M-COMMENT-REFLOW-TOUCHED-ONLY',
			'M-COMMENT-PARAGRAPH-UNGUARDED',
			'M-COMMENT-REFLOW-UNSAFE-LINES',
			'M-COMMENT-REFLOW-TRAILING-WRAPPED',
			'M-COMMENT-REFLOW-COUNT-ONLY',
			'M-COMMENT-WIDTH-CONFIG-BLIND',
			'M-COMMENT-WIDTH-CODE-BLIND',
			'M-COMMENT-WIDTH-TRAILING-WRAPPED',
			'M-COMMENT-WIDTH-FENCE-BLIND',
			'M-COMMENT-WIDTH-PROTECTION-OFF',
			'M-COMMENT-WIDTH-CLOSER-UNSEEN',
			'M-COMMENT-WIDTH-OPAQUE-OPEN',
			'M-COMMENT-WIDTH-PROTECTION-BY-TEXT',
			...
			'M-ELEMENT-LOOP-UNSTABLE',
			'M-ELEMENT-LOOP-REBIND',
			'M-ELEMENT-LOOP-CLOSURE',
			...
			'M-VALUE-LOOP-SELF-CALL',
			'M-KV-NOOPENER-INDEX-ONLY',
			'M-KV-NOOPENER-OPENER-CLAIM',
			...
			'M-ISVAR-EMPTY-CALL-UNFIXED',
			'M-ULB-VALUE-ITERATION-NEVER',
			'M-ULB-VALUE-ITERATION-ALWAYS',
			'M-ULB-VALUE-ITERATION-SHADOW-BLIND',
			'M-ULB-WILDCARD-KEY-ADMITTED',
			'M-ULB-OUTER-WILDCARD-BLIND',
			'M-ULB-SHADOW-COUNTED-AS-READ',
			'M-ULB-OUTER-BINDING-AS-SHADOW',
			'M-ULB-INTERP-BLIND',
			'M-ULB-INTERP-LITERAL-BLIND',
			'M-ULB-COVERAGE-BLIND',
			'M-ULB-OPAQUE-COND-BLIND',
			'M-ULB-NATIVE-BLIND',
			'M-ULB-UNTYPED-BLIND',
			'M-ULB-CLOSURE-BLIND',
			'M-ULB-COUNTER-CLAIM-BLIND',
			'M-MAPITERKEY-UNPROVEN-DROPPED',
			'M-ULB-REASSIGNED-LOCAL-BLIND',
			'M-ULB-IMPORT-ALIAS-BLIND',
			'M-ULB-IMPORT-REBIND-BLIND',
			'M-ULB-PATTERN-WILDCARD-UNEXEMPT',
	 ...
	 */
	private static function diffedMsg(expected: Array<String>, actual: Array<String>, baseMsg: String): String {
		final missing: Array<String> = [for (name in expected) if (!actual.contains(name)) name];
		final extra: Array<String> = [for (name in actual) if (!expected.contains(name)) name];
		final parts: Array<String> = [];
		if (missing.length > 0) parts.push('missing: ${missing.join(', ')}');
		if (extra.length > 0) parts.push('extra: ${extra.join(', ')}');
		return parts.length == 0 ? baseMsg : '$baseMsg (${parts.join('; ')})';
	}
