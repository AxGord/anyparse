...
class HxModifierSliceTest extends HxTestHelpers {
	...
	public function testSingleModifierPublic():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { public var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
	...
	public function testSingleModifierPrivate():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { private var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testSingleModifierStatic():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { static var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testSingleModifierInline():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { inline function f():Void {} }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testSingleModifierOverride():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { override function f():Void {} }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testSingleModifierFinal():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { final var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testSingleModifierDynamic():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { dynamic function f():Void {} }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testSingleModifierExtern():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { extern var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(1, m.modifiers.length);
	...
	public function testTwoModifiers():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { public static var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
	...
	public function testThreeModifiers():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { public static inline function f():Void {} }');
		final m:HxMemberDecl = ast.members[0];
	...
	public function testReversedOrder():Void {
		...
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { static public var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(2, m.modifiers.length);
		Assert.equals(Static, m.modifiers[0]);
	...
	public function testModifierBeforeFunction():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { override public function bar():Void {} }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(2, m.modifiers.length);
		Assert.equals(Override, m.modifiers[0]);
		Assert.equals(Public, m.modifiers[1]);
	...
	public function testWordBoundaryPublicly():Void {
		...
		Assert.raises(() -> HaxeFastParser.parse('class Foo { publicly var x:Int; }'), ParseError);
	}

	public function testWordBoundaryStatically():Void {
		Assert.raises(() -> HaxeFastParser.parse('class Foo { statically var x:Int; }'), ParseError);
	}
	...
	public function testDuplicateModifiersAllowed():Void {
		...
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { public public var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(2, m.modifiers.length);
		Assert.equals(Public, m.modifiers[0]);
		Assert.equals(Public, m.modifiers[1]);
	...
	public function testWhitespaceBetweenModifiers():Void {
		final ast:HxClassDecl = HaxeFastParser.parse('class Foo { public\t\nstatic   var x:Int; }');
		final m:HxMemberDecl = ast.members[0];
		Assert.equals(2, m.modifiers.length);
		Assert.equals(Public, m.modifiers[0]);
		Assert.equals(Static, m.modifiers[1]);
