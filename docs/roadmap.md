...
- Next recon-confirmed sole-blocker clusters: `.$ident` reification field-access in `macro` (`o callbacks.push(model.observables.$name.bind(...))`, ×4); fn-expr no-brace body (`[1,2,3].map(function() trace(i))`, ×4); `#error` directive (`indentation/issue_298_*`, ×3); `{> Base, fields}` structure-inheritance typedef (`whitespace/issue_202_*`, ×2).
