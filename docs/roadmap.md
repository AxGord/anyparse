...
- Still not shipped: `fitLineIfWithElse`, `elseIf`, nested-control-flow inside-out break ordering, blank-line preservation (ω), class/interface/abstract brace placement, object-literal `:` spacing, lossy `keep` config.
