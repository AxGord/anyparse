...
| [`journal/testing-log.md`](journal/testing-log.md) | journal | 319 KB | — | every reading and campaign narrative `testing.md` condensed, verbatim, under its origin section |
| [`journal/cli-query-log.md`](journal/cli-query-log.md) | journal | 124 KB | — | every reading and narrative `cli-query-tool.md` condensed, verbatim, under its origin section |
