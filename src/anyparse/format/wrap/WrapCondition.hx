 ...
 * not. The fork ships `exceedsMaxLineLength` in both polarities across its own corpus;
 * the other two it only ever ships at `1`, but the schema declares both for all three.
 *
