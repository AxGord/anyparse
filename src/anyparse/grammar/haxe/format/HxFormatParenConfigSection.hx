 ...
 * `catchParens`, `newParens`, `typeCheckParens`, `castParens`,
 * `checkParens`, `expressionParens` from haxe-formatter land with their
 * own slices when a writer knob catches up.
 */
