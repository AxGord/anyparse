 ...
 * The close-side pad is unaffected. Config `objectLiteralBraces.arrowBodyOpenPad: true` disables the
 * suppression (keeps the pad — a deliberate divergence from the fork). Cleared by `_setExprPosition` on
